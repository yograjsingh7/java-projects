...
public class HotelReservationSystem {
    ...
    private static final String password = "Yograj777";
    ...
    private static void viewReservations(Connection connection) throws SQLException{
        ...
        ResultSet resultSet = statement.executeQuery(sql)){
            ...
            while (resultSet.next()){
                ...
                //Format and display the reservation date in table - like format
    ...
    private static void updateReservation(Connection connection, Scanner scanner){
        try {
            ...
            int resrevationId = scanner.nextInt();
            scanner.nextLine();

            if (!reservationExists(connection,resrevationId)){
            ...
            String sql = "UPDATE reservations SET guest_name = '"+newGuestName+"', "+"room_number = "+newRoomNumber+", "+"contact_number = '"+newContactNumber+"' "+"WHERE reservation_id = "+resrevationId;
